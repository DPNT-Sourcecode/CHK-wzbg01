...
module.exports = function (input) {
    ...
    const itemArray = [
        ...
        ["L",0,90,0],
        ["M",0,15,0],
        ["N",0,40,0], //3N get one M free          [LIKE e]
        ["O",0,10,0],
        ["P",0,50,0], //5P for 200                 like b
        ["Q",0,30,0], //3Q for 80   
        ["R",0,50,0], //3R get one Q free          [like e]
        ["S",0,30,0],
        ["T",0,20,0],
    ...
    for(let index = 0 ; index < itemArray.length ; index++){        
        ...
        switch(item){
            ...
            case "K":
                ...
                itemArray[index][3] = (quantityPromoK*150 + remainderPromoK*unitPrice)
                break
            case "N":
                itemArray[index][3] = quantity*unitPrice

                //promo for N = 3N get one M free
                let countM = itemArray[13][1]
                ...
                if(quantityValidFreeM==0){
                    ...
                    item[13][3] = newMCountToPay*unitPrice
                }
                break
            case "P":
            ...
            case "U":
                if(quantity<3){
                    ...
                    itemArray[index][3] = 80
                } else {
                    let numberOfAvailableFreeU = Math.floor(quantity/3)
