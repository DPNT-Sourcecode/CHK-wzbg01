...
module.exports = function (skus) {
    ...
    const SKU_REGEX = new RegExp('^[ABCD]+$')
    ...
    for(let index = 0 ; index < skus.length ; index++){
        console.log(`index:${index} | value:${String(skus).charAt(index)}`)
    ...
    console.log(`countA:${countA} | countB:${countB} | countC:${countC} | countD:${countD}`)
