    ...
    for(const item of items){
        ...
        switch(item){
            ...
            case "E":
                ...
                console.log(quantityValidFreeB,countB)
                ...
                if(countB == 0){
                    ...
                    console.log(`B's:${countB} | valid free B's: ${quantityValidFreeB} | new purchase quantity: ${newQuantity}`)
