...
module.exports = function (input) {
    ...
    for(let index = 0 ; index < itemArray.length ; index++){        
        ...
        switch(item){
            ...
            case "Z":
                //array smallest number to highest, then for every 3 big elements, remove them for a 45
                console.log(itemArray[18])
                console.log(itemArray[19])
                console.log(itemArray[23])
                console.log(itemArray[24])
                console.log(itemArray[25])
