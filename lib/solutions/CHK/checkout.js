        ...
        switch(item){
            ...
            case "E":
                ...
                if(quantityValidFreeB == 0){
                    ...
                    let bFreeToAvail = countB-quantityValidFreeB
                    console.log(bPrice)
                    console.log(`B's:${countB} | Number Of Free B's Allowed:${quantityValidFreeB} | How much i need to pay: ${bFreeToAvail}`)
