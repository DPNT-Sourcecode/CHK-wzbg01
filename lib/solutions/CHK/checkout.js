    ...
    for(const pair of processedArray){
        ...
        switch(item){
            case "A":
                ...
                let sum = (quantityPromoA*130 + remainderPromoA*50)
                console.log(`sum = ${sum}`)
                break
            case "B":
                break
            ...
            case "D":
                break
            default:
                //should never happen. regex prevents this
                //reason for using switch case is linter usually says to use switch-case when more 
                //than 3 cases
                break
        }
    }
